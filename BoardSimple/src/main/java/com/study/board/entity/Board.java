...
public class Board {
     ...
     */
    @NotBlank(groups = UpdateBoardCheck.class)
    private int seq;
     ...
     * 카테고리 아이디
     */
    @NotBlank(groups = {SaveBoardCheck.class, UpdateBoardCheck.class})
     ...
     */
    @NotBlank(groups = {SaveBoardCheck.class, UpdateBoardCheck.class})
    @Size(min = 4, max = 100, groups = {SaveBoardCheck.class, UpdateBoardCheck.class})
     ...
     */
    @NotBlank(groups = {SaveBoardCheck.class, UpdateBoardCheck.class})
    @Size(min = 4, max = 2000, groups = {SaveBoardCheck.class, UpdateBoardCheck.class})
