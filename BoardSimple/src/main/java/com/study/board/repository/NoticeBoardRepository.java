...
public class NoticeBoardRepository {
    ...
    /**
     * 공지사항 게시글 (Notice Board) Mapper
     */
    private final NoticeBoardMapper boardMapper;
     ...
     * @return 자유게시글 리스트
     */
    public List<Board> findBoardList(BoardSearchCondition boardSearchCondition, int startRow) {
    ...
    public List<Board> findAlertList(int size) {
        return boardMapper.getAlertList(size);
    }
