...
import com.study.board.repository.GalleryBoardRepository;
...
public class GalleryBoardService {
     ...
     */
    private final GalleryBoardRepository boardRepository;
     ...
     * @return 게시글 리스트
     */
    public List<GalleryBoardDTO> findGalleryBoardList(BoardSearchCondition boardSearchCondition) {
     ...
     * @return 게시글 수
     */
    public int findGalleryBoardListCount(BoardSearchCondition boardSearchCondition) {
     ...
     * @return 조회한 게시글
     */
    public Board findGalleryBoard(int seq) {
     ...
     * 새로운 갤러리 게시글을 등록합니다.
     *
     * @param galleryBoardDTO 등록할 게시글 정보
     * @return 등록된 게시글 정보 (boardId 포함)
     * @throws IOException
     */
    public Board saveGalleryBoard(GalleryBoardDTO galleryBoardDTO) throws IOException {

        boardRepository.saveBoard(galleryBoardDTO);
        ...
        if (!ParamUtil.isNull(galleryBoardDTO.getAddFiles())) {
            ...
            for (MultipartFile file : galleryBoardDTO.getAddFiles()) {
                log.info("saveGalleryBoard의 file = {}", file);
     ...
     * @return
     */
    public GalleryBoardDTO updateGalleryBoard(GalleryBoardDTO paramBoard) throws IOException {
        // Board 게시글 수정
